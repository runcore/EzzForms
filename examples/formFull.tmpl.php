...
<head>
    ...
    <title>Ezz\Forms full form example</title>
...
<div class="container">
    ...
    <div class="form-group">
        <div class="col-md-offset-4 col-md-4"><h3><a href="./formFull.php">Ezz\Forms. Full form example</a></h3></div>
    </div>
    ...
    <div class="form-group">
        {label:password2:"Пароль еще раз" class="col-md-4 control-label"}
        <div class="col-md-4">
    ...
    <div class="form-group">
        {label:age:"Сколько вам лет:" class="col-md-4 control-label"}
        <div class="col-md-4">
            {field:age class="form-control"}
            {error:age class="text-danger small"}
        </div>
    </div>
    ...
    <div class="form-group">
        {label:towns2:"Города еще" class="col-md-4 control-label"}
        <div class="col-md-4">
            <div class="checkbox">
                {field:towns2}
    ...
    <div class="form-group">
        {label:towns3:"Город" class="col-md-4 control-label"}
        <div class="col-md-4">
            <div class="radio">
                {field:towns3}
    ...
    <div class="form-group">
        {label:text:"Комментарий" class="col-md-4 control-label"}
        <div class="col-md-4">
    ...
    <div class="form-group">
        {label:avatar:"Аватар" class="col-md-4 control-label"}
        <div class="col-md-4">
            <div class="radio">
                {field:avatar}
                {error:avatar class="text-danger small"}
            </div>
        </div>
    </div>
